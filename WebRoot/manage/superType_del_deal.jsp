...
if (ID.length>0){
	...
	if(ret==0){
		...
		out.println("<script lanuage='javascript'>alert('大分类信息删除成功!');window.location.href='index.jsp?id=5';</script>");
	}
}else{
	out.println("<script lanuage='javascript'>alert('您的操作有误!');window.location.href='index.jsp?id=5';</script>");
}
%>
