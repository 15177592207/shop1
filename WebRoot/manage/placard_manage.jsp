...
ResultSet rs=conn.executeQuery("select * from tb_BBS order by BBSUpdatetime Desc");
%>
<html>
<head>
...
<table width="800" border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="932" valign="top" background="images/content-bg.gif"><table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" class="left_topbg" id="table2">
      <tr>
        <td height="31"><div class="titlebt"><a href="index.jsp?id=12">添加公告</a></div></td>
      </tr>
    </table></td>
  ...
  <tr>
    ...
    <td valign="top" bgcolor="#F7F8F9"><p><img src="images/gggl.jpg"></p>
